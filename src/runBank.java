...
public class runBank implements Printable {
    ...
    static void runUI(List<customer> customerList) throws IOException, PasswordIncorrectException {
        ...
        if (isActionLog == 0) {
                        ...
                        if (inquireBy.equals("A")) {
                            ...
                            for (int i = 0; i < customerList.size(); i++) {
                                if (firstName.equals(customerList.get(i).getFirstName()) && lastName.equals(customerList.get(i).getLastName())) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        for (int j = 0; j < customerList.size(); j++) {
                                                            if (payeefirstName.equals(customerList.get(j).getFirstName()) && payeelastName.equals(customerList.get(j).getLastName())) {
                                                                ...
                                                                if (customerList.get(payeeAccountIndex).getCheckingaccount() == null) {
                                                                    System.err.println("That person does not have an account that can accept this transaction");
                                                                } else {
                                    ...
                                    if (customerList.get(accountIndex).getSavingsAccount() == null) {
                                        System.err.println("Account not found");
                                    } else {
                                        if (modifyType == 1) {
                                            do {
            ...
            for (int i = 0; i < customerList.size(); i++) {
                if (customerList.get(i).getCheckingaccount() == null && customerList.get(i).getCreditAccount() == null) {
                    out.println(customerList.get(i).getIdentificationNumber() + "," + customerList.get(i).getFirstName() + "," + customerList.get(i).getLastName() + "," + customerList.get(i).getDateOfBirth()
                            ...
                            + "," + "No Checking Account," + "No Checking Account Balance," + customerList.get(i).getSavingsAccount().accountNumber
                            + "," + customerList.get(i).getSavingsAccount().getBalance() + "," + "No Credit Account Number," + "No Credit Balance");
                }
                else if (customerList.get(i).getCheckingaccount() == null) {
                    out.println(customerList.get(i).getIdentificationNumber() + "," + customerList.get(i).getFirstName() + "," + customerList.get(i).getLastName() + "," + customerList.get(i).getDateOfBirth()
                            + "," + customerList.get(i).getAddress() + "," + customerList.get(i).getPhoneNumber()
                            + "," + "No Checking Account Number," + "No Checking Account Balance," + customerList.get(i).getSavingsAccount().accountNumber
                ...
                else if (customerList.get(i).getCreditAccount() == null) {
                    out.println(customerList.get(i).getIdentificationNumber() + "," + customerList.get(i).getFirstName() + "," + customerList.get(i).getLastName() + "," + customerList.get(i).getDateOfBirth()
                            + "," + customerList.get(i).getAddress() + "," + customerList.get(i).getPhoneNumber()
                            ...
                            + "," + customerList.get(i).getSavingsAccount().getBalance() + "," + "No Credit Account Number," + "No Credit Balence");
                } else {
                    out.println(customerList.get(i).getIdentificationNumber() + "," + customerList.get(i).getFirstName() + "," + customerList.get(i).getLastName() + "," + customerList.get(i).getDateOfBirth()
                            + "," + customerList.get(i).getAddress() + "," + customerList.get(i).getPhoneNumber()
                            + "," + customerList.get(i).getCheckingaccount().accountNumber + "," + customerList.get(i).getCheckingaccount().getBalance() + "," + customerList.get(i).getSavingsAccount().accountNumber
    ...
    static void runGui(List<customer> customerList) throws IOException, PasswordIncorrectException {
    ...
    static List<customer> makeCustomerList() throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            if (!line.isEmpty()) {
                ...
                int savingsAccNum = Integer.parseInt(values[12]);
                int creditAccNum = Integer.parseInt(values[5]);
                double checkingStart = Double.parseDouble(values[7]);
                double savingsStart = Double.parseDouble(values[9]);
                double creditStart = Double.parseDouble(values[11]);
                double creditMax = Double.parseDouble(values[14]);
                ...
                customer c = new customer(values[2], values[8], values[3], values[0], values[6], values[13], values[10], values[1], checkings, saving, credit) {
                };
                customerList.add(c);
            }
        }
